...
const comparisons: ComparisonRow[] = [
  ...
  { feature: "Evaluation Engine", model: false, mind: true, description: "Deterministic suites (correctness, quality, safety) feeding the gates; LLM-judge framework labeled, not used for promotion evidence" },
  { feature: "Evolution Engine", model: false, mind: true, description: "Candidate generation, sandboxing, gates, promotion, rollback" },
  { feature: "Genome/Versioning", model: false, mind: true, description: "Version, branch, diff, and rollback for a Mind's changes" },
